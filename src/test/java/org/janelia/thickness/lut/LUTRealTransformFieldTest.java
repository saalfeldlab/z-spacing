...
public class LUTRealTransformFieldTest {
	...
	private final LUTRealTransformField tf1 = new LUTRealTransformField( 4, 4, ArrayImgs.doubles( new double[] { 1.0, 2.0, 5.5, 6.0 }, 1, 1, 4 ) );
	private final LUTRealTransformField tf2 = new LUTRealTransformField( 4, 4, ArrayImgs.doubles( new double[] { 1.0, 3.5, 4.5, 5.0 }, 1, 1, 4 ) );
