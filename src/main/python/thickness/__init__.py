...
def generateDefaultOptionsAndOrderedKeys():
    ...
    addToOptionsAndKeys( 'rootDir', ( 'Root directory', '/groups/saalfeld/home/hanslovskyp/local/tmp/thickness_plugin_test/' ) ) # change to empty string
    ...
    addToOptionsAndKeys( 'correlationsRange', ( 'Correlation range', 8 ) )
    addToOptionsAndKeys( 'numberOfIterations', ( 'Number of iterations', 1 ) )
    addToOptionsAndKeys( 'numberOfThreads', ( 'Number of threads', 1 ) )
    addToOptionsAndKeys( 'crossCorrelationBlockRadius', ( 'Radius of blocks for cross-correlation', 16 ) )
    addToOptionsAndKeys( 'step', ( 'Sample step in x and y', 4 ) ) # change to 1
    addToOptionsAndKeys( 'neighborRegularizerWeight', ( 'Weight for regularization on neighbors\' shifts', 0.15 ) )
    addToOptionsAndKeys( 'shiftProportion', ( 'Proportion by which coordinate is shifted towards estimate.', 0.8 ) )
