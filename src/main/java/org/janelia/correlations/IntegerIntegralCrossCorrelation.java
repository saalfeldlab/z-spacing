...
//						new FloatType( 0.0f ),
//						new FloatType( 0.0f ) );
		final IntegerIntegralCrossCorrelation< LongType	, LongType, FloatType > ii = 
				new IntegerIntegralCrossCorrelation< LongType, LongType, FloatType >( img1, img2, new long[] { rad[0], rad[1] }, new FloatType() );
