 ...
 */
public class FloatingPointIntegralCrossCorrelation< T extends RealType< T >, U extends RealType< U >, S extends RealType< S > & NativeType< S > > extends
		IntegralCrossCorrelation<T, U, S, DoubleType > {
	
	public FloatingPointIntegralCrossCorrelation(
	...
	public FloatingPointIntegralCrossCorrelation(
			...
			throws NotEnoughSpaceException {
		super(img1, img2, r, type, new RealDoubleConverter< T >(), new RealDoubleConverter< U>(), resultDummy, new DoubleType() );
	}
...
//						new FloatType( 0.0f ),
//						new FloatType( 0.0f ) );
		final FloatingPointIntegralCrossCorrelation<FloatType, FloatType, FloatType> ii = 
				new FloatingPointIntegralCrossCorrelation< FloatType, FloatType, FloatType >( img1, img2, new long[] { rad[0], rad[1] }, new FloatType() );
