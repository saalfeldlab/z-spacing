 ...
 *
 */
public class DenseCorrelationStripsWithRadius< T extends NativeType< T > & RealType< T > > 
implements RandomAccessibleInterval<RandomAccessibleInterval<T> > {
	...
	public < U extends RealType< U > > DenseCorrelationStripsWithRadius( 
	...
	public class DenseCorrelationsRandomAccess extends Point implements RandomAccess< RandomAccessibleInterval<T> > {
		...
		public RandomAccessibleInterval<T> get() {
			DenseCorrelationStripsWithRadius<T>.MatrixStrip matrix = new MatrixStrip( position );
			return matrix;
		}
		...
		public RandomAccess<RandomAccessibleInterval<T>> copyRandomAccess() {
			DenseCorrelationStripsWithRadius<T>.DenseCorrelationsRandomAccess copy = 
	...
	public static void main(String[] args) throws NotEnoughSpaceException {
		...
		DenseCorrelationStripsWithRadius<DoubleType> dcwr = 
				new DenseCorrelationStripsWithRadius<DoubleType>(imageStack, radius, range, new DoubleType() );
