...
import org.janelia.utility.converter.IntegerToIntegerConverter;
 ...
 */
public class IntegerIntegralCrossCorrelationFromInteger< T extends IntegerType< T >, U extends IntegerType< U >, S extends RealType< S > & NativeType< S > > extends
