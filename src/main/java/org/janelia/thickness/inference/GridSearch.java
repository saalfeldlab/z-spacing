...
//		ImageJFunctions.show( matrix );
		...
		for ( double shiftProportion = 0.1; shiftProportion <= 1.0; shiftProportion += 0.04 )
		{
			...
			final String basePath = String.format( System.getProperty( "user.home" ) + "/z-spacing-gridsearch-chopped-single-parameter/%.4f", shiftProportion );
