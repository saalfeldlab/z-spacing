...
public class StepsMultiScaleVisitor implements MultiScaleVisitor {
...
private final String format;
	 ...
	 * @param format
	 */
	public StepsMultiScaleVisitor(final String format) {
		super();
		this.format = format;
	}
	...
	public void act(
		...
		final String data     = Arrays.toString( steps );
