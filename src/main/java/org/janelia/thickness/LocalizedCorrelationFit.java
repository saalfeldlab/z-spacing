...
//	public <M extends Model< M > > void estimateFromStrip(
//			final RandomAccessibleInterval< DoubleType > transformedCorrelations,
//			final RandomAccessibleInterval< DoubleType > multipliersTransformed,
//			final double[] weights,
//			final int range,
//			final M correlationFitModel,
...
//			double val = 0.5 * (3.0 * one.get() - two.get());
//			double reciprocal = 1.0 / val;
//			zero.set( val );
//			for( DoubleType d : Views.hyperSlice( fits, 0, m ) )
//				d.mul( reciprocal );
//
//		}
//
