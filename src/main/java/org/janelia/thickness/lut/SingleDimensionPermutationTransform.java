...
public class SingleDimensionPermutationTransform extends
	...
	/**
	 * @param lut
	 * @param numSourceDimensions dimensionality of source
	 * @param numTargetDimensions dimensionality of target
	 * @param d dimension which shall be transformed. Must be smaller than {@link #numSourceDimensions} and {@link #numTargetDimensions}
	 */
